...
for exp in "64-64-256" "64-64-512" "128-128-512" "128-128-1024"; do
    ...
    python src/validate_tvm.py --cpu --file "validate_tvm_1000_${exp}_f64.txt"
    ...
    python build_modules_on_scope.py --gpu 0 --scheduler ansor --ansor 1
    python src/validate_tvm.py --gpu --file "validate_tvm_1000_${exp}_f64_gpu.txt"
...
for exp in "32-32-32" "64-64-64" "128-128-128"; do
    ...
    python build_modules_on_scope.py --gpu 0 --scheduler ansor --ansor 1
    python src/validate_tvm.py --gpu --file "validate_tvm_1000_${exp}_f32_gpu.txt"
    # python run_experiment_on_scope.py --cpu --baseline --tvm 1 --jax --sample 1 --repeat 5 --max-threads $MAX_THREADS
done
